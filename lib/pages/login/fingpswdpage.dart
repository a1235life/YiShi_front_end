...
import 'emailtrue.dart';

class FindPswdPage extends StatefulWidget{

  @override
  FindPswdPageState createState() => new FindPswdPageState();
}

class FindPswdPageState extends State<FindPswdPage>{
                  ...
                  if ((_PhoneTextController.text == "")) {
                   ...
                   putdata();
                    Navigator.push(context, MaterialPageRoute(
                              builder: (context) => new EmailTruePage(),
                  ));
                  }
                });
              },
  ...
  Future putdata() async {
    ...
    global.set_email(apiPswd);
    var url='http://47.98.201.222:8181/user/validate_email';
